...
class LayoutKeyDelete extends StatelessWidget {
  LayoutKeyDelete({
    Key? key,
  }) : super(key: key);
  @override
                ...
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(start: 19.5, end: 19.5),
                        Pin(size: 40.0, middle: 0.4167),
                        child: Text(
                          '정말 등록된 잠금키를 삭제하시겠습니까?\n삭제 시, 복구가 불가능합니다.',
                          style: TextStyle(
                            fontFamily: 'Noto Sans CJK KR',
                            fontSize: 14,
                            color: const Color(0xff000000),
