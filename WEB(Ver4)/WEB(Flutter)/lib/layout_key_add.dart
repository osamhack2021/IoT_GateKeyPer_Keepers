...
class LayoutKeyAdd extends StatelessWidget {
  LayoutKeyAdd({
    Key? key,
  }) : super(key: key);
  @override
                ...
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(start: 19.0, end: 35.0),
                        Pin(size: 37.1, middle: 0.1695),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                              Pin(size: 42.0, start: 0.0),
                              Pin(size: 22.0, middle: 0.3893),
                              child: Text(
                                '크래들',
                                style: TextStyle(
                                  fontFamily: 'Noto Sans CJK KR',
                            ...
                            Pinned.fromPins(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Pinned.fromPins(
                                    Pin(size: 39.0, middle: 0.3192),
                                    Pin(start: 7.9, end: 8.7),
                                    child: Text(
                                      'COM1',
                                      style: TextStyle(
                                        fontFamily: 'Noto Sans CJK KR',
                                  ...
                                  Pinned.fromPins(
                                    ...
                                    child:
                                      ...
                                      children: <Widget>[
                                        Pinned.fromPins(
                                          Pin(start: 2.3, end: 1.8),
                                          Pin(size: 8.0, middle: 0.5271),
                                          child: SvgPicture.string(
                                            _svg_za65o3,
                                            allowDrawingOutsideViewBox: true,
                                            fit: BoxFit.fill,
                            ...
                            Pinned.fromPins(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Pinned.fromPins(
                                    Pin(start: 19.1, end: 20.0),
                                    Pin(size: 20.0, middle: 0.4608),
                                    child: Text(
                                      '연결 시도',
                                      style: TextStyle(
                                        fontFamily: 'Noto Sans CJK KR',
...
// background:
                      ...
                      Pinned.fromPins(
                        Pin(size: 216.0, start: 19.0),
                        Pin(size: 36.0, middle: 0.4472),
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: <Widget>[
                            SizedBox(
                            ...
                            Pinned.fromPins(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Pinned.fromPins(
                                    Pin(size: 226.0, start: 16.0),
                                    Pin(size: 19.0, start: 13.0),
                                    child: Text(
                                      '생활관 1층의 정문을 담당하고 있는 자물쇠',
                                      style: TextStyle(
                                        fontFamily: 'Noto Sans CJK KR',
                                        fontSize: 13,
                                        color: const Color(0xff3a3a3a),
...
const String _svg_pah3bl =
    '<svg viewBox="9.1 6.5 6.0 12.0" ><path transform="matrix(0.0, -1.0, 1.0, 0.0, 9.08, 18.5)" d="M 12 0 L 6 6 L 0 0" fill="none" stroke="#3a3a3a" stroke-width="2" stroke-linecap="butt" stroke-linejoin="round" /></svg>';
